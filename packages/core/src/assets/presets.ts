...
export const ASSET_PRESETS: readonly AssetPreset[] = [
  { kind: 'fund', label: 'Fund', subtype: 'investment', valuationMode: 'market', unitKind: 'units', lotSize: null, risk: 'high', planGroup: 'invest', coretaxSection: 'investasi', coretaxCode: '0306', priceLabel: 'NAV per unit' },
  { kind: 'stock', label: 'Stock', subtype: 'investment', valuationMode: 'market', unitKind: 'shares', lotSize: 100, risk: 'high', planGroup: 'invest', coretaxSection: 'investasi', coretaxCode: '0302', priceLabel: 'Closing price' },
  { kind: 'bond', label: 'Bond', subtype: 'investment', valuationMode: 'market', unitKind: 'face', lotSize: null, risk: 'low', planGroup: 'invest', coretaxSection: 'investasi', coretaxCode: '0304', priceLabel: 'Face value' },

/**
 * Merchant category code names from https://github.com/greggles/mcc-codes (mcc_codes.json, edited_description),
 * retrieved 2026-09-11. That repository is released under The Unlicense, dedicating it to the public domain.
 */

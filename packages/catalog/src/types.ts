...
export const CARD_MOTIFS = ['batik-floral', 'big-letter', 'rosette-tile', 'chrome-curves', 'ikat-diamonds', 'engraved-frame', 'portrait-oval', 'split-waves', 'colour-blocks', 'halftone-vortex', 'centre-ring', 'wing-bars', 'stadium', 'skyline', 'faceted-ribbon', 'horizon', 'swirl-edges', 'flight-line', 'sparse-diagonals', 'contour-lines', 'meridians', 'brushwing', 'guilloche-crest'] as const;

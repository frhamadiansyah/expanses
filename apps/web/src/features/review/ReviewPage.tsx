...
import { Figure, LargeTitle, RecordTable } from '../../ui/native';
 ...
 *
 * It is the kit's `RecordTable` without a `shape`, which is the kit's way of saying a record here has nowhere
 * to go. A draft has no page of its own: the two selects, Record and Discard are the whole reason to be on this
 * screen, so collapsing each draft to a title and a figure would leave a phone unable to action the queue at

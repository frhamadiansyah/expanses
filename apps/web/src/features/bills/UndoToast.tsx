...
/**
 * A short line saying what was just done, with the way back. It goes by itself after four seconds — but not while the
 * pointer rests on it or focus is inside it, so reaching for Undo never races the timer.
 */

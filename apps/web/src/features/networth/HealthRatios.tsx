import { healthRatios, type PeriodFlows, type RatioStatus, type SheetTotals } from '@expanses/core';
import { Card } from '../../ui';
...
export function HealthRatios({
  ...
  const ratios = healthRatios(flows ?? EMPTY_FLOWS, totals);
    ...
    <Card className="space-y-3">
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        {ratios.map((ratio) => {
          ...
          return (
            <div key={ratio.key} className="space-y-1.5 rounded-xl p-3 ring-1 ring-slate-200">

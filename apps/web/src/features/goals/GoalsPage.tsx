...
import { archiveGoal, type GoalHistoryEntry, type GoalLinkRow, type GoalPlanRow, type GoalRow, reorderGoals, setStagePaid } from '@expanses/db';
...
export function GoalsPage() {
  ...
  const goalSection = (card: GoalCard, plan: GoalPlanRow) => {
    // The plan and the card are one pair from `ordered`: never read a list by index beside them.

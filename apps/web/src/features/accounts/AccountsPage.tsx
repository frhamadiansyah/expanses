...
import { type CornerAction, Figure, InsetGroup, InsetRow, LargeTitle, RecordTable, SelectRow, TextRow } from '../../ui/native';
 ...
 *
 * It is `RecordTable` without a `shape`, and deliberately so. An account row carries four targets — its name,
